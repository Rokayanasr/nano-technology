                    ...
                    <ol className='items-center mt-14 mb-10 md:mt-8 justify-center flex flex-col md:flex-row gap-2'>
                        ...
                        <li className='relative mb-6 sm:mb-0'>
                            <div className='flex items-center justify-center'>
                                <div className='z-10 flex items-center justify-center w-6 h-6 bg-white rounded-full ring-0 ring-white '>
                                <svg id="fi_2282198" className="w-3.5 h-3.5 text-primary" fill='currentColor'  viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m512 121v-75c0-24.813-20.187-45-45-45h-422c-24.813 0-45 20.187-45 45v75zm-166-60h90c8.284 0 15 6.716 15 15s-6.716 15-15 15h-90c-8.284 0-15-6.716-15-15s6.716-15 15-15zm-150 0c8.284 0 15 6.716 15 15s-6.716 15-15 15-15-6.716-15-15 6.716-15 15-15zm-60 0c8.284 0 15 6.716 15 15s-6.716 15-15 15-15-6.716-15-15 6.716-15 15-15zm-60 0c8.284 0 15 6.716 15 15s-6.716 15-15 15-15-6.716-15-15 6.716-15 15-15z"></path><path d="m0 151v315c0 24.813 20.187 45 45 45h422c24.813 0 45-20.187 45-45v-315zm175.37 213.287c6.47 5.175 7.518 14.614 2.343 21.083-5.174 6.468-14.615 7.518-21.083 2.342l-75-60c-7.499-5.997-7.504-17.424 0-23.426l75-60c6.466-5.175 15.907-4.127 21.083 2.342 5.175 6.469 4.127 15.909-2.343 21.083l-60.358 48.289zm139.417-147.378-90 210c-3.263 7.613-12.079 11.143-19.696 7.878-7.614-3.263-11.142-12.082-7.878-19.696l90-210c3.264-7.614 12.082-11.141 19.696-7.878s11.142 12.081 7.878 19.696zm115.583 110.804-75 60c-6.458 5.168-15.9 4.136-21.083-2.342-5.175-6.469-4.127-15.909 2.343-21.083l60.358-48.288-60.358-48.287c-6.47-5.175-7.518-14.614-2.343-21.083 5.174-6.469 14.614-7.518 21.083-2.342l75 60c7.499 5.997 7.504 17.423 0 23.425z"></path></svg>
                                </div>
                                <div className='hidden sm:flex w-full consultancy-line' />
                            </div>
                            <div className='mt-3 sm:pe-8'>
                        ...
                        <li className='relative mb-6 sm:mb-0'>
                            <div className='flex items-center justify-center'>
                                <div className='z-10 flex items-center justify-center w-6 h-6 bg-white rounded-full ring-0 ring-white '>
                                <svg id="fi_7558195" viewBox="0 0 512 512" className="w-3.5 h-3.5 text-primary" fill='currentColor' xmlns="http://www.w3.org/2000/svg"><g><path d="m240.917 511.365v-212.993l-133.698 165.291c39.239 28.359 85.272 44.872 133.698 47.702z"></path><path d="m270.895 270.996v240.369c62.279-3.638 120.633-29.882 165.67-74.854 45.047-44.982 71.352-103.277 74.997-165.515z"></path><path d="m405.64 142.961h37.441v98.057h-37.441z"></path><path d="m75.346 75.499c-48.588 48.564-75.346 112.67-75.346 180.508s26.758 131.944 75.346 180.508c2.82 2.818 5.697 5.556 8.62 8.226l156.951-194.039v-250.067c-62.299 3.649-120.593 29.908-165.571 74.864z"></path><path d="m270.895 113.182h37.348v127.836h-37.348z"></path><path d="m338.221 41.048h37.441v199.971h-37.441z"></path><path d="m473.06 183.042h38.94v57.976h-38.94z"></path></g></svg>                                        <path d='M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z' />
                                </div>
                                <div className='hidden sm:flex w-full consultancy-line' />
                            </div>
                            <div className='mt-3 sm:pe-8'>
